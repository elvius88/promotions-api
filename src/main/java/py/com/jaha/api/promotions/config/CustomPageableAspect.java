...
import static py.com.jaha.api.promotions.constants.GlobalConstants.PARAM_PAGE_KEY_NAME;
import static py.com.jaha.api.promotions.constants.GlobalConstants.PARAM_PAGE_SIZE_NAME;
...
import py.com.jaha.api.promotions.commons.CustomPagination;

@Aspect
@Component
public class CustomPageableAspect {

  @Around("@annotation(py.com.jaha.api.promotions.config.CustomPageable) && execution(py.com.jaha.api.promotions.commons.ApiPageableResponse+ *(..)) && args(page, ..)")
